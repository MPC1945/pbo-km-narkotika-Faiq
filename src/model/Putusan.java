...
public class Putusan {
    ...
    public Putusan(String nomorPerkara, String namaTerdakwa, String pengadilan,
                   String tanggalPutusan, int umurTerdakwa, String jenisNarkotika,
    ...
    public String toString() {
        return String.format("%s | %s | %d bln | Rp %,.0f",
                nomorPerkara, namaTerdakwa, vonisHukuman, vonisDenda);
    }
}